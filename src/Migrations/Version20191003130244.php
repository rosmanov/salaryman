    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql(
            'CREATE TABLE salary_factor (
                ...
                `type` INT UNSIGNED NOT NULL DEFAULT 1 COMMENT "The type of salary factor. 1 - bonus, 2 - deduction",
                `value` DOUBLE PRECISION NOT NULL DEFAULT 0 COMMENT "The value to be added/deduced to/from the base salary",
                value_type INT UNSIGNED NOT NULL DEFAULT 1 COMMENT "The type of the value field. 1 - number, 2 - percents",
